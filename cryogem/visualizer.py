...
import time
import logging
from cryogem import html_helper, utils
...
try:
    ...
    logger.warning('Warning: wandb package cannot be found. The option "--use_wandb" will result in error.')
...
class Visualizer():
    ...
    def __init__(self, opt):
        ...
        if self.use_html:  # create an HTML object at <checkpoints_dir>/web/; images will be saved under <checkpoints_dir>/web/images/
            ...
            logger.info('create web directory %s...' % self.web_dir)
    ...
    def display_current_results(self, visuals, epoch, save_result):
        ...
        if self.use_html and (save_result or not self.saved):  # save images to an HTML file if they haven't been saved.
            ...
            # update website
            webpage = html_helper.HTML(self.web_dir, 'Experiment name = %s' % self.name, refresh=1)
    ...
    def print_current_losses(self, epoch, iters, losses, t_comp, t_data):
        ...
        logger.info(message)  # logger the message
        with open(self.log_name, "a") as log_file:
