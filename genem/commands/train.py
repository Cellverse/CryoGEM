...
from genem.options import process_opt, base_add_args
from genem.datasets import create_dataset
from genem.models import create_model
from genem.visualizer import Visualizer
from genem import models
from genem import datasets
from genem.config import _select_model, _select_dataset
...
def main(args):
    ...
    for epoch in range(opt.epoch_count, opt.n_epochs + opt.n_epochs_decay + 1):    # outer loop for different epochs; we save the model by <epoch_count>, <epoch_count>+<save_latest_freq>
        ...
        for i, data in enumerate(dataset):  # inner loop within one epoch
            ...
            if 'genem' in opt.model and epoch == opt.epoch_count and i == 0:
