...
def base_add_args(parser):
    ...
    # model parameters
    parser.add_argument('--model', type=str, default='genem', help='chooses which model to use. [cycle_gan | pix2pix | test | colorization]')
    ...
    # dataset parameters
    parser.add_argument('--dataset_mode', type=str, default='genem', help='chooses how datasets are loaded. [unaligned | aligned | single | colorization | cryoem | digitalem]')
